...
5. Sharing Data (Car Setups) The App provides a feature to export and import Car Setups using a unique text-based code (e.g., "SRC:..."). When you generate this code to share with friends, it is simply a text string generated locally on your device. We do not monitor, store, or intercept these shared codes.

6. Children's Privacy Because the App does not collect any personal data, it is completely safe for children of all ages.

7. Changes to This Privacy Policy We may update our Privacy Policy from time to time if new features require it. However, our commitment to zero data collection will remain our top priority. We will notify you of any changes by posting the new Privacy Policy on this page.
